...
CREATE TABLE `option` (
  ...
  CONSTRAINT `option_product_id` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`)
...
CREATE TABLE `order_list` (
  ...
  CONSTRAINT `order_list_option_id` FOREIGN KEY (`option_id`) REFERENCES `option` (`option_id`),
  KEY `order_list_order_id_idx` (`order_id`),
  CONSTRAINT `order_list_order_id` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
